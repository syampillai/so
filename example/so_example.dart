...
Future<void> main() async {
  ...
  if (status == "") {
    ...
    var (_, contentType, error) = await client.report(
      "com.storedobject.report.ObjectList",
      {
    ...
    (_, contentType, error) = await client.file(
    ...
    (_, contentType, error) = await client.report(
      "com.engravsystems.emqim.operations.logic.TestReport",
    );
    if (error == null) {
    ...
    attributes = {"className": "core.Person", "where": "FirstName LIKE 'H%'"};
